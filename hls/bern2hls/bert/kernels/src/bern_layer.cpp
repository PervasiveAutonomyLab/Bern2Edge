...
// ============================================================
// Bernstein full encoder layer top.
//   attention_sublayer -> per-token [fc1 -> bernstein -> fc2 -> +resid -> LN2]
// Weights streamed from DRAM; attention buffers live in attention.cpp.
// ============================================================

static data_t x_buf[SEQ_LEN][D_MODEL];        // layer input
static data_t xffn_buf[SEQ_LEN][D_MODEL];     // post-attention+LN1 (FFN input)
